...
const scriptInterface = class extends self.IWorldInstance {
  constructor() {
    super();
...
P_C.Instance = class extends C3.SDKWorldInstanceBase {
  ...
  Draw(renderer) {
    const texture = this.sourceTex || (this.source && this.source.GetTexture());
